...
function register_participant($conn){
    ...
    $query = "CALL sp_participant('','$name','$email','$phone','$location','$semid')";
...
function update_participant($conn){
    ...
    // Building the query and calling the stored procedure
    $query = "CALL sp_participant('$id','$name','$email','$phone','$location','$semid')";
...
function get_participant_report($conn){
    ...
    $data = array();
    $array_data = array();
    $query = "CALL rp_participant('$from','$to')";
    $result = $conn->query($query);
