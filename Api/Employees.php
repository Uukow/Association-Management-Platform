...
function register_employees($conn){
    ...
    $query = "CALL sp_employees('','$name','$position','$phone','$email','$location','$statuss')";
...
function update_employees($conn){
    ...
    // Building the query and calling the stored procedure
    $query = "CALL sp_employees('$id','$name','$position','$phone','$email','$location','$statuss')";
...
function get_employees_report($conn){
    ...
    $data = array();
    $array_data = array();
    $query = "CALL rp_employees('$from','$to')";
    $result = $conn->query($query);
