...
$.ajax({
    method: "GET",
    dataType: "json",
    url: "../Api/Association/Events.php",
...
$(document).ready(function() {
    ...
    function fetchNotifications() {
        $.ajax({
            url: '../Api/Association/Events.php', // Assuming this is the endpoint to fetch notifications
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.success) {
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 text-truncate ms-2">
                                            <h5 class="noti-item-title fw-semibold font-14">${notification.title} <small class="fw-normal text-muted ms-1">${notification.event_date}</small></h5>
