...
$("#addNew").on("click", function() {
  ...
  $("#verify").parent().hide();
  $("#statuss").parent().hide(); // Hide status input when updating
});
...
$("#userForm").on("submit", function(event) {
  ...
  let associationName = $("#associationName").val();
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      if (status) {
        ...
        $("#associationName").val(response['AssociationName']);
        $("#statuss").parent().show(); // Show status input when updating
        $("#verify").parent().show(); // Show verify input when updating
        $("#userModal").modal("show");
      } else {
        displayMessage("error", response);
      }
