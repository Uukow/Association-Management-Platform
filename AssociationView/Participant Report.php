        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Participant Report</h4>
                            <div class="card-block table-border-style">
                                <div class="table-responsive">
                                        ...
                                        <div class="row">
                                                ...
                                                <button type="submit" id="addNew" class="btn btn-info float-right m-2">Get participant Report</button>
...
?>
<script src="../js/Association/partReport.js"></script>