                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Attendence Sheet</h4>
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <button id="registerAttendanceBtn" class="btn btn-info float-right">Submit Attendence</button>
                                                <br><br>
                                                <table  class="table dt-responsive nowrap w-100" id="AttendanceTable">
                                                    <thead>
                                                        <tr>
                                                            <th>Employee ID</th>
                                                            <th>Name</th>
                                                            <th>AttendanceDate</eth>
                                                            <th>Check</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
...
?>
<script src="../js/Association/Attendence.js"></script>