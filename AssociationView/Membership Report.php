        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">membership Report</h4>
                            <div class="card-block table-border-style">
                                        ...
                                        <div class="row">
                                                ...
                                                <button type="submit" id="addNew" class="btn btn-info float-right m-2">membership Siminars</button>
...
?>
<script src="../js/Association/memReport.js"></script>