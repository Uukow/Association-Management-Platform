                        ...
                        <div class="card-body">
                            ...
                            <div class="card-block table-border-style">
                                <div class="table-responsive">
                                    <button id="addNew" class="btn btn-info float-right">Add New Proposer</button>
                                    <br><br>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Proposer Registeration</h5>
                            ...
                            <div class="modal-body">
                                      <form id="proposerForm">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="">proposer Decription</label>
...
?>
<script src="../js/Association/proposers.js"></script>