                        ...
                        <div class="card-body">
                            ...
                            <div class="card-block table-border-style">
                                <div class="table-responsive">
                                    ...
                                    <br><br>
                                                <table class="table dt-responsive nowrap w-100" id="associationTable">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                            ...
                            <div class="modal fade" id="associationModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
