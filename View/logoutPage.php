...
<!-- Mirrored from coderthemes.com/hyper/saas/pages-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 06:19:16 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body class="authentication-bg">
        ...
        <footer class="footer footer-alt">
            2017 - <script>document.write(new Date().getFullYear())</script> © MWN - Media Women Network
        </footer>
        <!-- Vendor js -->
