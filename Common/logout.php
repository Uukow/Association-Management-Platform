...
<head>
        <meta charset="utf-8" />
        <title>Logout | Association Management Platform</title>
    ...
    <body class="authentication-bg">
                    ...
                    <div class="col-xxl-4 col-lg-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Back to <a href="../Frontend/Pages/index.php" class="text-muted ms-1"><b>Log In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            2024 - <script>document.write(new Date().getFullYear())</script> © Association Management Platform
        </footer>
        <!-- Vendor js -->
